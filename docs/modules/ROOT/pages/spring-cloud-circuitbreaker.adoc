...
* https://docs.spring.io/spring-cloud-circuitbreaker/reference/{spring-cloud-version}/spring-cloud-circuitbreaker-resilience4j.html[Resilience4J]
* https://spring-cloud-alibaba-group.github.io/github-pages/2021/en-us/index.html#_circuit_breaker_spring_cloud_circuit_breaker_with_sentinel_configuring_sentinel_circuit_breakers[Sentinel]
* https://docs.spring.io/spring-cloud-circuitbreaker/reference/{spring-cloud-version}/spring-cloud-circuitbreaker-spring-retry.html[Spring Retry]
...
It is useful where calling `customize` many times doesn't make sense, for example, in case of https://resilience4j.readme.io/docs/circuitbreaker#consume-emitted-circuitbreakerevents[consuming Resilience4j's events].
