...
If you would like to customize the retry functionality throughout Spring Cloud(Include `BackOffPolicy`、`RetryListener`、`LoadBalancedRetryPolicy`).You need to create a bean of type `LoadBalancedRetryFactory`.As shown in the following example:
    ...
    public LoadBalancedRetryFactory loadBalancedRetryFactory() {
        return new LoadBalancedRetryFactory() {
            ...
            public LoadBalancedRetryPolicy createRetryPolicy(String service, ServiceInstanceChooser serviceInstanceChooser) {
                return new MyLoadBalancedRetryPolicy();
            }
