...
NOTE: Since 2.2.0 we also provide a `ReactiveDiscoveryClient` interface.
All existing functionality of a `DiscoveryClient` has been made available to be used in a non-blocking application.
