...
If you would like to implement a `RecoveryCallback` in your retries you will need to
create a bean of type `LoadBalancedRetryRecoveryCallbackFactory`, and return the `RecoveryCallback`
you would like to use for a given service.
...
public class MyConfiguration {
    @Bean
    public LoadBalancedRetryRecoveryCallbackFactory recoveryCallbackFactory() {
        return new LoadBalancedRetryRecoveryCallbackFactory() {
            @Override
            public RecoveryCallback createRecoveryCallback(String service) {
                    ...
                    public ClientHttpResponse recover(RetryContext context) throws Exception {
                        return new ClientHttpResponse() {
                            ...
                            public InputStream getBody() throws IOException {
                                return new ByteArrayInputStream("recovery callback...".getBytes());
                            }
