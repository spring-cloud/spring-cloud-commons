...
public class EnableDiscoveryClientImportSelectorTests {
	...
	public void autoRegistrationIsEnabled() {
		...
		assertTrue(this.environment
			.getProperty("spring.cloud.service-registry.auto-registration.enabled", Boolean.class, true));
	...
	public void autoRegistrationIsDisabled() {
		...
		String[] imports = this.importSelector.selectImports(this.annotationMetadata);
		assertFalse(this.environment
			.getProperty("spring.cloud.service-registry.auto-registration.enabled", Boolean.class));
