 ...
 */
public class JacksonMapper2 extends JsonMapper {

	private static Log logger = LogFactory.getLog(JacksonMapper2.class);

	private final ObjectMapper mapper;

	public JacksonMapper2(ObjectMapper mapper) {
		this.mapper = mapper;
	}
