...
/**
 * Tests for {@link ReactiveApiVersionServiceInstanceListSupplier}.
 *
 * @author Olga Maciaszek-Sharma
 */
class ReactiveApiVersionServiceInstanceListSupplierTests {
	...
	private ReactiveApiVersionServiceInstanceListSupplier supplier;
	...
	void setUp() {
		...
		supplier = new ReactiveApiVersionServiceInstanceListSupplier(delegate, loadBalancerClientFactory);
	...
	private Map<String, String> buildApiVersionMetadata(String apiVersion) {
		...
		metadata.put(ReactiveApiVersionServiceInstanceListSupplier.API_VERSION, apiVersion);
		return metadata;
	}
